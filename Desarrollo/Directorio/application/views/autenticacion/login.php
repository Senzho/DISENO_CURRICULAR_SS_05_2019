    ...
    <div id="pagina" class="pagina centradoVerticalPadre">
        <div id="bloqueLogin" class="bloque centradoHorizontal centradoVerticalPadre">
            <div id="bloqueFormulario" class="centradoHorizontal">
                <h1 class="titulo1 centro">Iniciar sesión</h1>
                <?php echo form_open('Autenticacion/iniciar_sesion',array('id'=>'', 'class'=>''))?>
                    <input type="text" id="" class="control campoTexto block centradoHorizontal" placeholder="Usuario" required="" autofocus="" name="nick">
                    <input type="password" id="" class="control campoTexto block centradoHorizontal" placeholder="Contraseña" required="" name="contraseña">
                    <input class="boton block centradoHorizontal" type="submit" id="" value="Ingresar"/>
                </form>
